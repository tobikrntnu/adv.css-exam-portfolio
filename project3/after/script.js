document.addEventListener("DOMContentLoaded", () => {
  ...
  const infoTexts = [
    'Ships have some of the lowes emissions compared to other methods!',
...
buyBtn.addEventListener('click', () => {
  if (!selectedColorName) {
    alert('Vennligst velg en farge først!');
    return;
  }
  ...
  buyBtn.textContent = 'Lagt til!';

  setTimeout(() => {
    thankYouMsg.classList.add('hidden');
    buyBtn.disabled = false;
    buyBtn.textContent = 'Kjøp denne';
  }, 3000);
});
